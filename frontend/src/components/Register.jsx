    ...
    <div className="min-h-[calc(100vh-56px)] flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="text-xl font-semibold text-[var(--text-main)] tracking-tight">Create an account</h2>
          <p className="text-[var(--text-muted)] mt-1.5 text-sm">Join us to start organizing your thoughts.</p>
        </div>
        ...
        <div className="bg-[var(--bg-surface)] border border-[var(--border-main)] rounded-xl p-6 sm:p-8 shadow-[var(--shadow-subtle)]">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-1.5">
              <label className="text-xs font-semibold text-[var(--text-main)] uppercase tracking-wider block">Username</label>
              <input
                type="text"
                value={username}
        ...
        <div className="mt-6 text-center text-sm text-[var(--text-muted)]">
          ...
          <Link to="/login" className="font-medium text-[var(--text-main)] hover:underline transition-colors">
            Sign in
          </Link>
        </div>
